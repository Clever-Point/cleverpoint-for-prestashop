...
<div class="panel" id="clever_point_order_admin_block">
    <div class="panel-heading">
        <i class="icon-truck"></i> {l s='Clever Point' mod='afcleverpoint'}
    </div>
        ...
        <form id="clever_point_order_admin_form" class="form-horizontal">
            ...
            <div class="form-group row text-right">
                <button type="submit" id="afcp-order-form-submit"
                    ...
                    <i class="icon-truck"></i> {l s='Create voucher' mod='afcleverpoint'}
                </button>
                <button type="submit" id="afcp-order-form-submit"
                    ...
                    <i class="icon-remove"></i> {l s='Cancel voucher' mod='afcleverpoint'}
                </button>
            </div>
            {/if}
        </form>
        ...
        <form method="post" {if !empty({$tpl_vars.print_url})}action="{$tpl_vars.print_url}"{/if} target="_blank" enctype="multipart/form-data">
            ...
            <div class="text-right">
                <button type="submit" id="afcp-order-form-print" {if (empty({$tpl_vars.print_url}))}disabled{/if}
                    ...
                    <i class="icon-print"></i> {l s='Print voucher' mod='afcleverpoint'}
                </button>
            </div>
        </form>
        {/if}
