...
<div class="af-cleverpoint">
    <input type="hidden" name="af-cleverpoint-selected-point" id="af-cleverpoint-selected-point"
           value="{if isset($afcp_tpl_vars.delivery_station.StationId)}{$afcp_tpl_vars.delivery_station.StationId}{/if}">
    <input type="hidden" name="af-cleverpoint-initialize-map" id="af-cleverpoint-initialize-map"
           value="0">
            ...
            <label class="cleverpointBox__label" for="afcp_pickup_from_cleverpoint">
                <div class="cleverpointBox__row">
                    <div class="cleverpointBox__col cleverpointBox__col--auto">
                        <input id="afcp_pickup_from_cleverpoint" type="checkbox"
                               {if ($afcp_tpl_vars.deliver_order_with_cp)}checked="checked"{/if} value="1"
                               name="afcp_pickup_from_cleverpoint">
                    </div>
                    <div class="cleverpointBox__col cleverpointBox__col--auto">
                    ...
                    <div class="cleverpointBox__col cleverpointBox__col-md--col">
                        <div class="cleverpointBox__content">
                            ...
                            <div class="cleverpointBox__text">Η μεταφορική - courier θα αφήσει το δέμα στο σημείο της
                                επιλογής σου για να το παραλάβεις όποτε σε βολεύει χωρίς άγχος. Ένα έξυπνο σημείο είναι
                                πάντα δίπλα σου.
                            </div>
                        </div>
                    </div>
    ...
    <div id="af-cleverpoint-checkout-container" class="af-cleverpoint-wrap mb-1"
         {if !($afcp_tpl_vars.station_customer_selected)}style="display:none"{/if}>
